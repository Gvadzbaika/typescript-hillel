...
describe('Accountant', () => {
    ...
    beforeEach(() => {
        ...
        mockZooBudget = new budget_1.ZooBudget(5000); // Ініціалізуємо мокований об'єкт ZooBudget
        // Ініціалізуємо об'єкт Accountant з мокованими даними
        accountant = new accounting_1.Accountant(mockEmployees, mockAnimals, mockZooBudget);
    });
    ...
    test('addTicketSale method should add payment to payments array', () => {
        const mockPayment = { recipient: 'Recipient', amount: 500 };
    ...
    test('calculateTotalExpenses method should return the sum of employee salaries', () => {
        ...
        const expectedExpenses = mockEmployees.reduce((acc, curr) => acc + curr.salary, 0);
